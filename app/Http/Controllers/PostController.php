...
class PostController extends Controller
{
    ...
    public function indexPostsList()
    {
        ...
        return Inertia::render('Posts/IndexPosts', [
            'posts'=>Post::latest()->join('categories', 'posts.category_id', '=', 'categories.id')->join('users', 'posts.user_id', '=', 'users.id')->where('users.id', '=', $userIdLoged)->select('posts.*', 'categories.title as category_title', 'users.name as user_name')
          ]);
    }
